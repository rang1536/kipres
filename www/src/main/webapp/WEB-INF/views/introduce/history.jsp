...
<div id="sub_wrapper">
		<div id="sub_con_wrapper">
			<div id="left_wrapper">
				...
				<ul>
					<a href="greeting">인사말<i class="fa fa-chevron-right"></i></a>	
					<a href="outline">학회개요<i class="fa fa-chevron-right"></i></a>
					<a class="active" href="history">학회연혁<i class="fa fa-chevron-right"></i></a>
					<a href="chart">조직도<i class="fa fa-chevron-right"></i></a>			
					<a href="committee">위원회<i class="fa fa-chevron-right"></i></a>	
					<a href="rule">회칙<i class="fa fa-chevron-right"></i></a>
				</ul>
			</div>
			<div id="right_wrapper">
				<div id="right_path">
					<h5><i class="fa fa-home"></i>&nbsp; > 학회소개 > 학회연혁</h5>
				</div>
